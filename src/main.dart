...
class MyWellbeingState extends State<MyWellbeing> {
  ...
  Widget build(BuildContext context) {
    ...
    Color backgroundColor = Color.lerp(
        Color.lerp(color1[200], color2[200], (MyWellbeing.emotion / 100)),
        Color.lerp(color2[200], color3[200], (MyWellbeing.emotion / 100)),
        (MyWellbeing.emotion / 100));
    ...
    return MaterialApp(
        ...
        home: FutureBuilder(
            ...
            builder:
              ...
              MyWellbeing.name = "John"; //TODO TEMP
                          ...
                          FadeUp(
                              ...
                              Column(
                                children: <Widget>[
                                  ...
                                  Visibility(
                                      visible:
                                          MyWellbeing.selectedEmotion != null,
                                      child: Container(
